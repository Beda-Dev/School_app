...
class HomeWorkItem extends StatelessWidget {
  ...
  final VoidCallback? onNotePressed; // Fonction à exécuter lorsque le bouton est pressé
  ...
  Widget build(BuildContext context) {
    ...
    Color backgroundColor = showButton ? Colors.transparent : Colors.transparent;
